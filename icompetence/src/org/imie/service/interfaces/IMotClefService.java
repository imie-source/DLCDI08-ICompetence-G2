...
public interface IMotClefService extends ITransactional {
	...
	public abstract MotClefDTO findById(Integer motClefid)
			throws TransactionalConnectionException;

	public abstract MotClefDTO insertmotClef(MotClefDTO motClefToInsert)
			throws TransactionalConnectionException;

	public abstract MotClefDTO updatemotClef(MotClefDTO motClefToUpdate)
			throws TransactionalConnectionException;

	public abstract void deletemotClef(MotClefDTO motClefToDelete)
			throws TransactionalConnectionException;
